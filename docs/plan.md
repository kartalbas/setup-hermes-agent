...
- [x] Private/business split in OneDrive (2026-09-07): `Secretary/Business/` and `Secretary/Private/`, file names end with `_bus` / `_pri`, enforced by the drive tools, world decided at intake for every scan, photo, mail and task; `m365ctl migrate-worlds` for existing files
